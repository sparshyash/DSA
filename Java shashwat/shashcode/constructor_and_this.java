class Vehicle {
    ...
    Vehicle(String model, int speed){
        this(); //current class constructor call , call default 
        // this(new Vehicle()) copy constructor call 
...
class constructor_and_this{
    public static void main(String[] args) {
        ...
        System.out.println("after v3 speed: " + v3.getSpeed()); // ref copy  both ref pt to same object
